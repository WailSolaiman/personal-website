...
function HeroFrame() {
  const { t } = useTranslation("heroframe")
  const features = t("heroframe:features", { returnObjects: true })
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <motion.div {...imageReveal}>
            <a
              ...
              aria-label={t("heroframe:cta")}
            >
              <img
                src="/images/webanimateweb2.webp"
                alt={t("heroframe:imageAlt")}
                loading="lazy"
                decoding="async"
